        ...
        <div className="grid sm:grid-cols-3 gap-8 mb-8">
          ...
          <div className="flex flex-col items-center sm:items-start">
            ...
            <div className="flex space-x-3 mt-3">
              <a href="https://www.instagram.com/hairmechanics1997" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gold-500 transition-colors" aria-label="Instagram" onClick={() => trackSocialClick('instagram')}>
                <Instagram className="h-5 w-5" />
              </a>
              <a href="https://www.facebook.com/hairmechanics1997" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gold-500 transition-colors" aria-label="Facebook" onClick={() => trackSocialClick('facebook')}>
                <Facebook className="h-5 w-5" />
              </a>
              <a href="https://www.tiktok.com/@glencelestial" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gold-500 transition-colors" aria-label="TikTok" onClick={() => trackSocialClick('tiktok')}>
              ...
              <a href="https://www.google.com/maps/place/Hair+Mechanics+LLC" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gold-500 transition-colors" aria-label="Google Business Profile" onClick={() => trackSocialClick('google')}>
