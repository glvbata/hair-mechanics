...
const RentonPage = () => (
  <PageLayout
    ...
    canonical="https://hairmechanics.com/renton-barber"
  >
    ...
    <section className="py-16 bg-dark-900">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          {[
            { icon: MapPin, title: 'Easy Drive from Renton', desc: 'Located at 1251 A St, Auburn — quick trip south via WA-167.' },
            { icon: Star, title: '5.0 Google Rating', desc: 'Trusted by clients from Renton, Kent, Auburn, and beyond.' },
