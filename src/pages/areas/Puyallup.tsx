...
const PuyallupPage = () => (
  <PageLayout
    title="Barber Shop Near Puyallup WA | Hair Mechanics Auburn | Haircuts & Fades"
    description={`Looking for a barber near Puyallup, WA? Hair Mechanics in Auburn is a quick drive away. Expert haircuts, fades, beard trims. Walk-ins welcome. Call ${PHONE_DISPLAY}.`}
    canonical={url}
  >
    <HeroSection
      ...
      description={
        <>
          <p>Hair Mechanics in Auburn is a quick drive from Puyallup. Expert haircuts, clean fades, and beard trims — walk-ins welcome.</p>
          <div className="mt-3 text-gray-400 text-sm flex items-center justify-center">
            <MapPin className="h-4 w-4 mr-1" /> About 15 minutes from Puyallup
          </div>
        </>
      }
    ...
    <section className="py-16 bg-dark-900">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          {[
            { icon: MapPin, title: 'Easy Drive from Puyallup', desc: `Located at ${ADDRESS.full} — quick trip via WA-167 or WA-512.` },
            { icon: Star, title: `${RATING} Google Rating`, desc: `Trusted by clients across the South King County and Pierce County area — ${REVIEWS_COUNT} reviews.` },
