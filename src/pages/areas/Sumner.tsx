...
const SumnerPage = () => (
  <PageLayout
    title="Barber Shop Near Sumner WA | Hair Mechanics Auburn | Haircuts & Fades"
    description="Looking for a barber near Sumner, WA? Hair Mechanics in Auburn is just minutes away. Expert haircuts, fades, beard trims. Walk-ins welcome. Call (206) 399-9288."
    canonical="https://hairmechanics.com/sumner-barber"
  >
    ...
    <section className="py-16 bg-dark-900">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          {[
            { icon: MapPin, title: 'Close to Sumner', desc: 'Located at 1251 A St, Auburn — quick drive via WA-167.' },
            { icon: Star, title: '5.0 Google Rating', desc: 'Trusted by clients from Sumner, Auburn, and the valley.' },
