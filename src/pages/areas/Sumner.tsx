...
const SumnerPage = () => (
  <PageLayout
    ...
    description={`Looking for a barber near Sumner, WA? Hair Mechanics in Auburn is just minutes away. Expert haircuts, fades, beard trims. Walk-ins welcome. Call ${PHONE_DISPLAY}.`}
    canonical={url}
  >
    <HeroSection
      ...
      description={
        <>
          <p>Hair Mechanics in Auburn is just a quick drive from Sumner. Expert haircuts, clean fades, and beard trims — walk-ins welcome.</p>
    ...
    <section className="py-16 bg-dark-900">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          {[
            { icon: MapPin, title: 'Close to Sumner', desc: `Located at ${ADDRESS.full} — quick drive via WA-167.` },
