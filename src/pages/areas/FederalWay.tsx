...
const FederalWayPage = () => (
  <PageLayout
    title="Barber Shop Near Federal Way WA | Hair Mechanics Auburn | Haircuts & Fades"
    description="Looking for a barber near Federal Way, WA? Hair Mechanics in Auburn is worth the drive. Expert haircuts, fades, beard trims. Walk-ins welcome. Call (206) 399-9288."
    canonical="https://hairmechanics.com/federal-way-barber"
  >
    <section className="relative py-20 sm:py-28">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
        <h1 className="text-3xl sm:text-5xl font-bold">
          <span className="text-amber-500">Barber Shop Near Federal Way</span>
        </h1>
        <p className="mt-4 text-lg text-gray-300 max-w-xl mx-auto">
          Hair Mechanics in Auburn is a short drive from Federal Way. Expert haircuts, clean fades, and beard trims — walk-ins welcome.
        </p>
        <div className="mt-3 text-gray-400 text-sm flex items-center justify-center">
          <MapPin className="h-4 w-4 mr-1" /> About 15 minutes from Federal Way
        </div>
    ...
    <section className="py-16 bg-dark-900">
      <div className="max-w-4xl mx-auto px-4">
        <h2 className="text-2xl font-bold text-amber-500 text-center mb-10">Why Federal Way Clients Choose Us</h2>
        <div className="grid sm:grid-cols-2 gap-6">
          {[
            { icon: MapPin, title: 'Easy Drive from Federal Way', desc: 'Located at 1251 A Street NE, Auburn — quick trip via WA-18 or I-5.' },
            { icon: Star, title: '4.5 Google Rating', desc: 'Clients from Federal Way, Auburn, and beyond trust our work — 83 reviews.' },
    ...
    <section className="py-16 bg-amber-500">
      <div className="max-w-3xl mx-auto px-4 text-center">
        <h2 className="text-3xl font-bold text-gray-900 mb-4">Worth the Drive from Federal Way</h2>
