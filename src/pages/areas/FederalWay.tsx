...
const FederalWayPage = () => (
  <PageLayout
    ...
    description={`Looking for a barber near Federal Way, WA? Hair Mechanics in Auburn is worth the drive. Expert haircuts, fades, beard trims. Walk-ins welcome. Call ${PHONE_DISPLAY}.`}
    canonical={url}
  >
    <HeroSection
      ...
      description={
        <>
          <p>Hair Mechanics in Auburn is a short drive from Federal Way. Expert haircuts, clean fades, and beard trims — walk-ins welcome.</p>
    ...
    <section className="py-16 bg-dark-900">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          {[
            { icon: MapPin, title: 'Easy Drive from Federal Way', desc: `Located at ${ADDRESS.full} — quick trip via WA-18 or I-5.` },
