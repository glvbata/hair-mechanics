  ...
  >
    <section className="relative py-20 sm:py-28">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
        <h1 className="text-3xl sm:text-5xl font-bold">
          <span className="text-amber-500">Barber Shop Near Kent, WA</span>
        </h1>
        <p className="mt-4 text-lg text-gray-300 max-w-xl mx-auto">
          Hair Mechanics in Auburn is just a short drive from Kent. Expert haircuts, clean fades, and beard trims — walk-ins welcome.
        </p>
    ...
    <section className="py-16 bg-amber-500">
      <div className="max-w-3xl mx-auto px-4 text-center">
        <h2 className="text-3xl font-bold text-gray-900 mb-4">Worth the Short Drive from Kent</h2>
